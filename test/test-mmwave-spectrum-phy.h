...
/**
 * \ingroup nr-tests
 * This is MmWaveSpectrumPhy noise configuration test case.
 ...
 * The test suite that runs different test cases to test MmWaveSpectrumPhy.
 */
class MmWaveSpectrumPhyTestSuite : public TestSuite
{
public:
  /** Constructor. */
  MmWaveSpectrumPhyTestSuite ();
};
