...
PrintConfigPaths(std::ostream& os, const TypeId tid)
{
    ...
    {
        os << headingStart << "config_" << tid.GetUid() << " Config Paths" << headingStop
           << std::endl;
        os << std::endl;
...
PrintAttributes(std::ostream& os, const TypeId tid)
{
    ...
    {
        os << headingStart << "attr_" << tid.GetUid() << " Attributes" << headingStop << std::endl;
    ...
    while (tmp.GetParent() != tmp)
    {
        ...
        {
            os << headingStart << "attr_parent_" << tid.GetUid()
               << " Attributes defined in parent class " << tmp.GetName() << headingStop
               << std::endl;
...
PrintTraceSources(std::ostream& os, const TypeId tid)
{
    ...
    {
        os << headingStart << "tracesources_" << tid.GetUid() << " TraceSources" << headingStop
           << std::endl;
    ...
    while (tmp.GetParent() != tmp)
    {
        ...
        {
            os << headingStart << "tracesources_parent_" << tid.GetUid()
               << " TraceSources defined in parent class " << tmp.GetName() << headingStop
               << std::endl;
...
PrintAllGlobals(std::ostream& os)
{
    ...
    for (auto i = GlobalValue::Begin(); i != GlobalValue::End(); ++i)
    {
        StringValue val;
        (*i)->GetValue(val);
        os << indentHtmlOnly << listLineStart << boldStart << anchor << "GlobalValue"
           << (*i)->GetName() << " " << (*i)->GetName() << boldStop << ": " << (*i)->GetHelp()
...
PrintAttributeImplementations(std::ostream& os)
{
    ...
    const AttributeDescriptor attributes[] = {
        ...
        {"DsssParameterSet", "DsssParameterSet", true, "dsss-parameter-set.h"},
        {"EdcaParameterSet", "EdcaParameterSet", true, "edca-parameter-set.h"},
