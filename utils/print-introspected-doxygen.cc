...
GetNameMap (void)
{
  ...
  static std::list<TypeId> types =
  {
    ...
    NrAmc::GetTypeId (),
    MmWaveUePhy::GetTypeId (),
    MmWaveUeNetDevice::GetTypeId (),
    MmWaveUeMac::GetTypeId (),
    MmWaveSpectrumPhy::GetTypeId (),
    mmWaveUeRrcProtocolIdeal::GetTypeId (),
    MmWaveRadioBearerTag::GetTypeId (),
    MmWavePhy::GetTypeId (),
    MmWaveNetDevice::GetTypeId (),
    MmWaveMacScheduler::GetTypeId (),
    MmWaveMacSchedulerTdma::GetTypeId (),
    MmWaveMacSchedulerTdmaRR::GetTypeId (),
    MmWaveMacSchedulerTdmaPF::GetTypeId (),
    MmWaveMacSchedulerTdmaMR::GetTypeId (),
    MmWaveMacSchedulerOfdma::GetTypeId (),
    MmWaveMacSchedulerOfdmaRR::GetTypeId (),
    MmWaveMacSchedulerOfdmaPF::GetTypeId (),
    MmWaveMacSchedulerOfdmaMR::GetTypeId (),
    MmWaveMacSchedulerNs3::GetTypeId (),
    MmWaveMacSchedulerNs3Base::GetTypeId (),
    MmWaveMacPduTag::GetTypeId (),
    MmWaveMacPduHeader::GetTypeId (),
    mmWaveInterference::GetTypeId (),
    MmWaveHelper::GetTypeId (),
    MmWaveEnbPhy::GetTypeId (),
    MmWaveEnbNetDevice::GetTypeId (),
    MmWaveEnbMac::GetTypeId (),
