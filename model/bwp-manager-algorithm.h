...
class BwpManagerAlgorithm : public Object
{
  public:
     ...
     */
    virtual uint8_t GetBwpForQosFlow(const NrQosFlow::Qci& v) const = 0;
};
...
class BwpManagerAlgorithmStatic : public BwpManagerAlgorithm
{
  public:
    ...
    // inherited
    uint8_t GetBwpForQosFlow(const NrQosFlow::Qci& v) const override;
    ...
    {
        m_qciToBwpMap[NrQosFlow::GBR_CONV_VOICE] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::GBR_CONV_VOICE);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::GBR_CONV_VIDEO] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::GBR_CONV_VIDEO);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::GBR_GAMING] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::GBR_GAMING);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::GBR_NON_CONV_VIDEO] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::GBR_NON_CONV_VIDEO);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::GBR_MC_PUSH_TO_TALK] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::GBR_MC_PUSH_TO_TALK);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::GBR_NMC_PUSH_TO_TALK] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::GBR_NMC_PUSH_TO_TALK);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::GBR_MC_VIDEO] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::GBR_MC_VIDEO);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::GBR_V2X] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::GBR_V2X);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::NGBR_IMS] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::NGBR_IMS);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::NGBR_VIDEO_TCP_OPERATOR] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::NGBR_VIDEO_TCP_OPERATOR);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::NGBR_VOICE_VIDEO_GAMING] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::NGBR_VOICE_VIDEO_GAMING);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::NGBR_VIDEO_TCP_PREMIUM] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::NGBR_VIDEO_TCP_PREMIUM);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::NGBR_VIDEO_TCP_DEFAULT] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::NGBR_VIDEO_TCP_DEFAULT);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::NGBR_MC_DELAY_SIGNAL] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::NGBR_MC_DELAY_SIGNAL);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::NGBR_MC_DATA] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::NGBR_MC_DATA);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::NGBR_V2X] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::NGBR_V2X);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::NGBR_LOW_LAT_EMBB] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::NGBR_LOW_LAT_EMBB);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::DGBR_DISCRETE_AUT_SMALL] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::DGBR_DISCRETE_AUT_SMALL);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::DGBR_DISCRETE_AUT_LARGE] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::DGBR_DISCRETE_AUT_LARGE);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::DGBR_ITS] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::DGBR_ITS);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::DGBR_ELECTRICITY] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::DGBR_ELECTRICITY);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::GBR_LIVE_UL_71] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::GBR_LIVE_UL_71);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::GBR_LIVE_UL_72] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::GBR_LIVE_UL_72);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::GBR_LIVE_UL_73] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::GBR_LIVE_UL_73);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::GBR_LIVE_UL_74] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::GBR_LIVE_UL_74);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::GBR_LIVE_UL_76] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::GBR_LIVE_UL_76);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::DGBR_INTER_SERV_87] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::DGBR_INTER_SERV_87);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::DGBR_INTER_SERV_88] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::DGBR_INTER_SERV_88);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::DGBR_VISUAL_CONTENT_89] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::DGBR_VISUAL_CONTENT_89);
    }
    ...
    {
        m_qciToBwpMap[NrQosFlow::DGBR_VISUAL_CONTENT_90] = bwpIndex;
    }
    ...
    {
        return m_qciToBwpMap.at(NrQosFlow::DGBR_VISUAL_CONTENT_90);
    }
