...
public:
  ...
  uint32_t GetTbSizeFromMcsSymbols (unsigned mcs, unsigned nsym, unsigned nprb) const;
  uint32_t GetTbSizeFromMcsSymbols (unsigned mcs, unsigned nprb) const;
  double GetSpectralEfficiency (unsigned mcs, unsigned nsymb, unsigned nprb) const;
  double GetSpectralEfficiency (unsigned mcs, unsigned nprb) const;
  ...
  std::vector<int> CreateCqiFeedbacksTdma (const SpectrumValue& sinr, uint8_t numSym, unsigned nprb);
  uint8_t CreateCqiFeedbackWbTdma (const SpectrumValue& sinr, uint8_t numSym, uint32_t tbs, uint8_t &mcsWb);
