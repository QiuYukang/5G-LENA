...
NS_LOG_COMPONENT_DEFINE ("MmWaveMacSchedulerLCG");

MmWaveMacSchedulerLC::MmWaveMacSchedulerLC (const LogicalChannelConfigListElement_s &conf)
...
void
MmWaveMacSchedulerLCG::AssignedData (uint8_t lcId, uint32_t size)
{
