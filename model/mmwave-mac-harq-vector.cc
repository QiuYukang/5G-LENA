...
bool
MmWaveMacHarqVector::Erase (uint8_t id)
{
  at (id).Erase ();
  --m_usedSize;
...
bool
MmWaveMacHarqVector::Insert (uint8_t *id, const HarqProcess& element)
{
...
std::ostream &
operator<< (std::ostream & os, MmWaveMacHarqVector const & item)
{
