...
bool
NrRlcAmHeader::IsDataPdu() const
{
    return m_dataControlBit == DATA_PDU;
}

bool
NrRlcAmHeader::IsControlPdu() const
{
...
void
NrRlcAmHeader::SetSequenceNumber(nr::SequenceNumber10 sequenceNumber)
{
...
uint16_t
NrRlcAmHeader::PopLengthIndicator()
{
...
uint8_t
NrRlcAmHeader::GetPollingBit() const
{
    return m_pollingBit;
}
...
uint8_t
NrRlcAmHeader::GetLastSegmentFlag() const
{
...
uint16_t
NrRlcAmHeader::GetLastOffset() const
{
    return m_lastOffset;
}

void
NrRlcAmHeader::SetAckSn(nr::SequenceNumber10 ackSn)
{
    m_ackSn = ackSn;
}
...
bool
NrRlcAmHeader::IsNackPresent(nr::SequenceNumber10 nack)
{
...
nr::SequenceNumber10
NrRlcAmHeader::GetAckSn() const
{
    return m_ackSn;
}

TypeId
NrRlcAmHeader::GetTypeId()
{
...
TypeId
NrRlcAmHeader::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
uint32_t
NrRlcAmHeader::GetSerializedSize() const
{
    return m_headerLength;
}

void
NrRlcAmHeader::Serialize(Buffer::Iterator start) const
{
...
uint32_t
NrRlcAmHeader::Deserialize(Buffer::Iterator start)
{
    Buffer::Iterator i = start;
    uint8_t byte_1;
    uint8_t byte_2;
