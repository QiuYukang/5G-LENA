...
#include "mmwave-mac-harq-process.h"
 ...
 * \see HarqProcess
 */
class MmWaveMacHarqVector : private std::unordered_map<uint8_t, HarqProcess>
{
public:
  friend std::ostream &  operator<< (std::ostream & os, MmWaveMacHarqVector const & item);
  /**
