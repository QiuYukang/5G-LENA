...
class NrSlChunkProcessor : public SimpleRefCount<NrSlChunkProcessor>
{
  ...
  private:
    std::vector<NrSlChunkValue>
        m_chunkValues; ///< Vector to hold NrSlChunkValue of Signals received on Sidelink

    std::vector<NrSlChunkProcessorCallback>
        m_nrSlChunkProcessorCallbacks; ///< chunk processor callback
};
