...
class NrSlBwpManagerUe : public BwpManagerUe
{
  ...
  protected:
     ...
     */
    std::vector<NrSlUeBwpmRrcSapProvider::SlLcInfoBwpm> DoAddNrSlDrbLc(
     ...
     *         the size of the vector is equal to the number of bandwidth part manager enabled.
     */
    std::vector<NrSlUeBwpmRrcSapProvider::SlLcInfoBwpm> DoAddNrSlSrbLc(
        const NrSlUeCmacSapProvider::SidelinkLogicalChannelInfo& lcInfo,
        NrSlMacSapUser* msu);
     ...
     *         the size of the vector is equal to the number of bandwidth part manager enabled.
     */
    std::vector<NrSlUeBwpmRrcSapProvider::SlLcInfoBwpm> DoAddNrSlDiscoveryRbLc(
        const NrSlUeCmacSapProvider::SidelinkLogicalChannelInfo& lcInfo,
        NrSlMacSapUser* msu);
  ...
  private:
     ...
     * \returns true if first NrSlUeBwpLcIdentifier parameter values are less than the second
     * NrSlUeBwpLcIdentifier parameters"
     */
    ...
    std::map<NrSlUeBwpLcIdentifier, NrSlMacSapUser*>
        m_nrSlDrbLcInfoMap; //!< NR Sidelink data radio bearer logical channel info map
    std::map<NrSlUeBwpLcIdentifier, EpsBearer::Qci>
        m_slLcToBearerMap; //!< Map from LCID to bearer Qci/priority
    ...
    std::map<uint8_t, NrSlMacSapProvider*>
        m_nrSlMacSapProvidersMap; //!< Map of pointers to the NR SL MAC SAP Provider interface of
                                  //!< the UE.
    ...
    NrSlMacSapProvider*
        m_nrSlBwpmUeMacSapProvider; //!< Receive API calls from the UE RLC instance for UE MAC
    NrSlMacSapUser*
        m_nrSlBwpmUeMacSapUser; //!< Receive API calls from the UE MAC instance for UE RLC
