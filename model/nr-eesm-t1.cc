...
NrEesmT1::NrEesmT1()
{
    ...
    m_mcsEcrTable = &NrMcsTables::GetMcsEcrTableRef(1);
    m_simulatedBlerFromSINR = &BlerForSinr1;
    m_mcsMTable = &NrMcsTables::GetMcsMTableRef(1);
    m_spectralEfficiencyForMcs = &NrMcsTables::GetSpectralEfficiencyForMcsRef(1);
    m_spectralEfficiencyForCqi = &NrMcsTables::GetSpectralEfficiencyForCqiRef(1);
}
