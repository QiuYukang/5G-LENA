    ...
    static TypeId tid =
        TypeId("ns3::BwpManagerAlgorithmStatic")
            ...
            DECLARE_ATTR("GBR_MC_PUSH_TO_TALK",
                         "BWP index to which flows of GBR_MC_PUSH_TO_TALK Qci type should "
                         "be forwarded.",
                         GetMcPttBwp,
                         SetMcPttBwp)
            DECLARE_ATTR("GBR_NMC_PUSH_TO_TALK",
                         "BWP index to which flows of GBR_NMC_PUSH_TO_TALK Qci type should be "
                         "forwarded.",
                         GetNmcPttBwp,
                         SetNmcPttBwp)
            ...
            DECLARE_ATTR("NGBR_IMS",
                         "BWP index to which flows of NGBR_IMS "
                         "Qci type should be forwarded.",
                         GetImsBwp,
                         SetImsBwp)
            ...
            DECLARE_ATTR("NGBR_VOICE_VIDEO_GAMING",
                         "BWP index to which flows of NGBR_VOICE_VIDEO_GAMING Qci "
                         "type should be forwarded.",
                         GetVideoGamingBwp,
                         SetVideoGamingBwp)
            ...
            DECLARE_ATTR("NGBR_VIDEO_TCP_DEFAULT",
                         "BWP index to which flows of NGBR_VIDEO_TCP_DEFAULT "
                         "Qci type should be forwarded.",
            ...
            DECLARE_ATTR("NGBR_MC_DATA",
                         "BWP index to which flows of NGBR_MC_DATA Qci "
                         "type should be forwarded.",
                         GetMcDataBwp,
                         SetMcDataBwp)
            ...
            DECLARE_ATTR("NGBR_LOW_LAT_EMBB",
                         "BWP index to which flows of NGBR_LOW_LAT_EMBB Qci type "
                         "should be forwarded.",
                         GetLowLatEmbbBwp,
                         SetLowLatEmbbBwp)
            DECLARE_ATTR("DGBR_DISCRETE_AUT_SMALL",
                         "BWP index to which flows of DGBR_DISCRETE_AUT_SMALL Qci "
                         "type should be forwarded.",
                         GetDiscreteAutSmallBwp,
                         SetDiscreteAutSmallBwp)
            DECLARE_ATTR("DGBR_DISCRETE_AUT_LARGE",
                         "BWP index to which flows of DGBR_DISCRETE_AUT_LARGE Qci type "
                         "should be forwarded.",
                         GetDiscreteAutLargeBwp,
                         SetDiscreteAutLargeBwp)
            DECLARE_ATTR("DGBR_ITS",
                         "BWP index to which flows of DGBR_ITS Qci type should be "
                         "forwarded.",
                         GetItsBwp,
                         SetItsBwp)
            DECLARE_ATTR("DGBR_ELECTRICITY",
                         "BWP index to which flows of DGBR_ELECTRICITY Qci "
                         "type should be forwarded.",
                         GetElectricityBwp,
                         SetElectricityBwp)
            DECLARE_ATTR("GBR_LIVE_UL_71",
                         "BWP index to which flows of GBR_LIVE_UL_71 Qci "
                         "type should be forwarded.",
                         GetLiveUlStream71Bwp,
                         SetLiveUlStream71Bwp)
            DECLARE_ATTR("GBR_LIVE_UL_72",
                         "BWP index to which flows of GBR_LIVE_UL_72 Qci "
                         "type should be forwarded.",
                         GetLiveUlStream72Bwp,
                         SetLiveUlStream72Bwp)
            DECLARE_ATTR("GBR_LIVE_UL_73",
                         "BWP index to which flows of GBR_LIVE_UL_73 Qci "
                         "type should be forwarded.",
                         GetLiveUlStream73Bwp,
                         SetLiveUlStream73Bwp)
            DECLARE_ATTR("GBR_LIVE_UL_74",
                         "BWP index to which flows of GBR_LIVE_UL_74 Qci "
                         "type should be forwarded.",
                         GetLiveUlStream74Bwp,
                         SetLiveUlStream74Bwp)
            DECLARE_ATTR("GBR_LIVE_UL_76",
                         "BWP index to which flows of GBR_LIVE_UL_76 Qci "
                         "type should be forwarded.",
                         GetLiveUlStream76Bwp,
                         SetLiveUlStream76Bwp)
            DECLARE_ATTR("DGBR_INTER_SERV_87",
                         "BWP index to which flows of DGBR_INTER_SERV_87 Qci "
                         "type should be forwarded.",
                         GetInterService87Bwp,
                         SetInterService87Bwp)
            DECLARE_ATTR("DGBR_INTER_SERV_88",
                         "BWP index to which flows of DGBR_INTER_SERV_88 Qci "
                         "type should be forwarded.",
                         GetInterService88Bwp,
                         SetInterService88Bwp)
            DECLARE_ATTR("DGBR_VISUAL_CONTENT_89",
                         "BWP index to which flows of DGBR_VISUAL_CONTENT_89 Qci "
                         "type should be forwarded.",
                         GetVisualContant89Bwp,
                         SetVisualContant89Bwp)
            DECLARE_ATTR("DGBR_VISUAL_CONTENT_90",
                         "BWP index to which flows of DGBR_VISUAL_CONTENT_90 Qci "
                         "type should be forwarded.",
