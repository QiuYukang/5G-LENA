        ...
        TypeId("ns3::BwpManagerAlgorithmStatic")
            ...
            .AddConstructor<BwpManagerAlgorithmStatic>() DECLARE_ATTR(
                ...
                DECLARE_ATTR(
                    ...
                    GetGamingBwp,
                    SetGamingBwp) DECLARE_ATTR("GBR_NON_CONV_VIDEO",
                    ...
                    DECLARE_ATTR("GBR_MC_PUSH_TO_TALK",
                        ...
                        DECLARE_ATTR(
                            ...
                            "forwarded.",
                            GetNmcPttBwp,
                            SetNmcPttBwp) DECLARE_ATTR("GBR_MC_VIDEO",
                                        ...
                                        DECLARE_ATTR(
                                            ...
                                            DECLARE_ATTR(
                                                ...
                                                DECLARE_ATTR(
                                                    ...
                                                    "type should be forwarded.",
                                                    GetMcDataBwp,
                                                    SetMcDataBwp) DECLARE_ATTR("NGBR_V2X",
                                                                               "BWP index to which "
                                                                               "flows of NGBR_V2X "
                                                                               "Qci type should be "
                                                                               "forwarded.",
                                                    ...
                                                    DECLARE_ATTR("NGBR_LOW_LAT_EMBB",
                                                        ...
                                                        DECLARE_ATTR("DGBR_DISCRETE_AUT_SMALL",
                                                            ...
                                                            DECLARE_ATTR(
                                                                ...
                                                                "BWP index to which flows of "
                                                                "DGBR_DISCRETE_AUT_LARGE Qci type "
                                                                "should be forwarded.",
