...
TypeId
NrAsn1Header::GetTypeId()
{
    static TypeId tid = TypeId("ns3::NrAsn1Header").SetParent<Header>().SetGroupName("Nr");
    return tid;
}

TypeId
NrAsn1Header::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
uint32_t
NrAsn1Header::GetSerializedSize() const
{
...
void
NrAsn1Header::Serialize(Buffer::Iterator bIterator) const
{
    if (!m_isDataSerialized)
    {
        PreSerialize();
...
void
NrAsn1Header::WriteOctet(uint8_t octet) const
{
...
template <int N>
void
NrAsn1Header::SerializeBitset(std::bitset<N> data) const
{
...
template <int N>
void
NrAsn1Header::SerializeBitstring(std::bitset<N> data) const
{
    SerializeBitset<N>(data);
}

void
NrAsn1Header::SerializeBitstring(std::bitset<1> data) const
{
    SerializeBitstring<1>(data);
}

void
NrAsn1Header::SerializeBitstring(std::bitset<2> data) const
{
    SerializeBitstring<2>(data);
}

void
NrAsn1Header::SerializeBitstring(std::bitset<8> data) const
{
    SerializeBitstring<8>(data);
}

void
NrAsn1Header::SerializeBitstring(std::bitset<10> data) const
{
    SerializeBitstring<10>(data);
}

void
NrAsn1Header::SerializeBitstring(std::bitset<16> data) const
{
    SerializeBitstring<16>(data);
}

void
NrAsn1Header::SerializeBitstring(std::bitset<27> data) const
{
    SerializeBitstring<27>(data);
}

void
NrAsn1Header::SerializeBitstring(std::bitset<28> data) const
{
    SerializeBitstring<28>(data);
}

void
NrAsn1Header::SerializeBitstring(std::bitset<32> data) const
{
...
template <int N>
void
NrAsn1Header::SerializeSequence(std::bitset<N> optionalOrDefaultMask,
...
void
NrAsn1Header::SerializeSequence(std::bitset<0> optionalOrDefaultMask,
                                bool isExtensionMarkerPresent) const
{
...
void
NrAsn1Header::SerializeSequence(std::bitset<1> optionalOrDefaultMask,
                                bool isExtensionMarkerPresent) const
{
...
void
NrAsn1Header::SerializeSequence(std::bitset<2> optionalOrDefaultMask,
                                bool isExtensionMarkerPresent) const
{
...
void
NrAsn1Header::SerializeSequence(std::bitset<3> optionalOrDefaultMask,
                                bool isExtensionMarkerPresent) const
{
...
void
NrAsn1Header::SerializeSequence(std::bitset<4> optionalOrDefaultMask,
                                bool isExtensionMarkerPresent) const
{
...
void
NrAsn1Header::SerializeSequence(std::bitset<5> optionalOrDefaultMask,
                                bool isExtensionMarkerPresent) const
{
...
void
NrAsn1Header::SerializeSequence(std::bitset<6> optionalOrDefaultMask,
                                bool isExtensionMarkerPresent) const
{
...
void
NrAsn1Header::SerializeSequence(std::bitset<7> optionalOrDefaultMask,
                                bool isExtensionMarkerPresent) const
{
...
void
NrAsn1Header::SerializeSequence(std::bitset<9> optionalOrDefaultMask,
                                bool isExtensionMarkerPresent) const
{
...
void
NrAsn1Header::SerializeSequence(std::bitset<10> optionalOrDefaultMask,
                                bool isExtensionMarkerPresent) const
{
...
void
NrAsn1Header::SerializeSequence(std::bitset<11> optionalOrDefaultMask,
                                bool isExtensionMarkerPresent) const
{
...
void
NrAsn1Header::SerializeSequenceOf(int numElems, int nMax, int nMin) const
{
...
void
NrAsn1Header::SerializeEnum(int numElems, int selectedElem) const
{
...
void
NrAsn1Header::SerializeChoice(int numOptions,
                              int selectedOption,
                              bool isExtensionMarkerPresent) const
{
    if (isExtensionMarkerPresent)
...
void
NrAsn1Header::SerializeInteger(int n, int nmin, int nmax) const
{
...
void
NrAsn1Header::SerializeNull() const
{
    // Clause 18 ITU-T X.691
}

void
NrAsn1Header::FinalizeSerialization() const
{
    if (m_numSerializationPendingBits > 0)
    {
        m_numSerializationPendingBits = 0;
...
template <int N>
Buffer::Iterator
NrAsn1Header::DeserializeBitset(std::bitset<N>* data, Buffer::Iterator bIterator)
{
    int bitsToRead = N;
    uint8_t mask;
...
template <int N>
Buffer::Iterator
NrAsn1Header::DeserializeBitstring(std::bitset<N>* data, Buffer::Iterator bIterator)
{
    return DeserializeBitset<N>(data, bIterator);
}

Buffer::Iterator
NrAsn1Header::DeserializeBitstring(std::bitset<1>* data, Buffer::Iterator bIterator)
{
    return DeserializeBitstring<1>(data, bIterator);
}

Buffer::Iterator
NrAsn1Header::DeserializeBitstring(std::bitset<2>* data, Buffer::Iterator bIterator)
{
    return DeserializeBitstring<2>(data, bIterator);
}

Buffer::Iterator
NrAsn1Header::DeserializeBitstring(std::bitset<8>* data, Buffer::Iterator bIterator)
{
    return DeserializeBitstring<8>(data, bIterator);
}

Buffer::Iterator
NrAsn1Header::DeserializeBitstring(std::bitset<10>* data, Buffer::Iterator bIterator)
{
    return DeserializeBitstring<10>(data, bIterator);
}

Buffer::Iterator
NrAsn1Header::DeserializeBitstring(std::bitset<16>* data, Buffer::Iterator bIterator)
{
    return DeserializeBitstring<16>(data, bIterator);
}

Buffer::Iterator
NrAsn1Header::DeserializeBitstring(std::bitset<27>* data, Buffer::Iterator bIterator)
{
    return DeserializeBitstring<27>(data, bIterator);
}

Buffer::Iterator
NrAsn1Header::DeserializeBitstring(std::bitset<28>* data, Buffer::Iterator bIterator)
{
...
Buffer::Iterator
NrAsn1Header::DeserializeBoolean(bool* value, Buffer::Iterator bIterator)
{
...
Buffer::Iterator
NrAsn1Header::DeserializeInteger(int* n, int nmin, int nmax, Buffer::Iterator bIterator)
{
...
Buffer::Iterator
NrAsn1Header::DeserializeChoice(int numOptions,
...
Buffer::Iterator
NrAsn1Header::DeserializeEnum(int numElems, int* selectedElem, Buffer::Iterator bIterator)
{
...
template <int N>
Buffer::Iterator
NrAsn1Header::DeserializeSequence(std::bitset<N>* optionalOrDefaultMask,
                                  bool isExtensionMarkerPresent,
                                  Buffer::Iterator bIterator)
{
    if (isExtensionMarkerPresent)
...
Buffer::Iterator
NrAsn1Header::DeserializeSequence(std::bitset<0>* optionalOrDefaultMask,
                                  bool isExtensionMarkerPresent,
                                  Buffer::Iterator bIterator)
{
...
Buffer::Iterator
NrAsn1Header::DeserializeSequence(std::bitset<1>* optionalOrDefaultMask,
                                  bool isExtensionMarkerPresent,
                                  Buffer::Iterator bIterator)
{
...
Buffer::Iterator
NrAsn1Header::DeserializeSequence(std::bitset<2>* optionalOrDefaultMask,
                                  bool isExtensionMarkerPresent,
                                  Buffer::Iterator bIterator)
{
...
Buffer::Iterator
NrAsn1Header::DeserializeSequence(std::bitset<3>* optionalOrDefaultMask,
                                  bool isExtensionMarkerPresent,
                                  Buffer::Iterator bIterator)
{
...
Buffer::Iterator
NrAsn1Header::DeserializeSequence(std::bitset<4>* optionalOrDefaultMask,
                                  bool isExtensionMarkerPresent,
                                  Buffer::Iterator bIterator)
{
...
Buffer::Iterator
NrAsn1Header::DeserializeSequence(std::bitset<5>* optionalOrDefaultMask,
                                  bool isExtensionMarkerPresent,
                                  Buffer::Iterator bIterator)
{
...
Buffer::Iterator
NrAsn1Header::DeserializeSequence(std::bitset<6>* optionalOrDefaultMask,
                                  bool isExtensionMarkerPresent,
                                  Buffer::Iterator bIterator)
{
...
Buffer::Iterator
NrAsn1Header::DeserializeSequence(std::bitset<7>* optionalOrDefaultMask,
                                  bool isExtensionMarkerPresent,
                                  Buffer::Iterator bIterator)
{
...
Buffer::Iterator
NrAsn1Header::DeserializeSequence(std::bitset<9>* optionalOrDefaultMask,
                                  bool isExtensionMarkerPresent,
                                  Buffer::Iterator bIterator)
{
...
Buffer::Iterator
NrAsn1Header::DeserializeSequence(std::bitset<10>* optionalOrDefaultMask,
                                  bool isExtensionMarkerPresent,
                                  Buffer::Iterator bIterator)
{
...
Buffer::Iterator
NrAsn1Header::DeserializeSequence(std::bitset<11>* optionalOrDefaultMask,
                                  bool isExtensionMarkerPresent,
                                  Buffer::Iterator bIterator)
{
...
Buffer::Iterator
NrAsn1Header::DeserializeNull(Buffer::Iterator bIterator)
{
    return bIterator;
}

Buffer::Iterator
NrAsn1Header::DeserializeSequenceOf(int* numElems, int nMax, int nMin, Buffer::Iterator bIterator)
{
