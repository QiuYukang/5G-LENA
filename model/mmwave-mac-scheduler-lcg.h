 ...
 * \see GetTotalSize
 */
class MmWaveMacSchedulerLC
{
public:
  /**
   * \brief MmWaveMacSchedulerLC constructor
   * \param conf Configuration of the LC
   */
  MmWaveMacSchedulerLC (const LogicalChannelConfigListElement_s &conf);
  /**
   * \brief MmWaveMacSchedulerLC default constructor (deletec)
   */
  MmWaveMacSchedulerLC () = delete;
  /**
   * \brief MmWaveMacSchedulerLC copy constructor (deleted)
   * \param o other instance
   */
  MmWaveMacSchedulerLC (const MmWaveMacSchedulerLC &o) = delete;
   ...
   */
  int
  Update (const MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
  {
 ...
 * MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters.
 *
 ...
 * \see UpdateInfo
 */
class MmWaveMacSchedulerLCG
{
public:
  /**
   * \brief MmWaveMacSchedulerLCG constructor
   ...
   */
  MmWaveMacSchedulerLCG (const MmWaveMacSchedulerLCG &other) = delete;
   ...
   *
   * A call to MmWaveMacSchedulerLC::Update is performed.
   */
  void
  UpdateInfo (const MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
  {
   ...
   *
   * \see MmWaveMacSchedulerLC::OverwriteTxQueueSize()
   */
  void
