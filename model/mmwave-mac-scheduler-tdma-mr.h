 ...
 */
class MmWaveMacSchedulerTdmaMR : public MmWaveMacSchedulerTdmaRR
{
public:
  /**
   * \brief GetTypeId
  ...
  /**
   * \brief MmWaveMacSchedulerTdmaMR constructor
   */
  MmWaveMacSchedulerTdmaMR ();

  /**
   * \brief ~MmWaveMacSchedulerTdmaMR deconstructor
   */
  virtual ~MmWaveMacSchedulerTdmaMR () override
  {
  }
