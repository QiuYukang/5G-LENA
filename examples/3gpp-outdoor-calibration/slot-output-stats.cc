...
SlotOutputStats::SetDb(SQLiteOutput* db, const std::string& tableName)
{
    ...
    SlotOutputStats::DeleteWhere(m_db,
...
void
SlotOutputStats::DeleteWhere(SQLiteOutput* p, uint32_t seed, uint32_t run, const std::string& table)
{
    bool ret;
    sqlite3_stmt* stmt;
