                                          ...
                                          bool enableShadowing)
{
    ...
    Config::SetDefault("ns3::LteEnbPhy::NoiseFigure", DoubleValue(gnbNoiseFigure));
    ...
    lteHelper->SetPathlossModelAttribute("ShadowingEnabled", BooleanValue(enableShadowing));
