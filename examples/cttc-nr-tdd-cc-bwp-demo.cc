...
NS_LOG_COMPONENT_DEFINE ("NrTddComponentCarriersBandwidthPartsExample");
...
//      std::vector<ComponentCarrierInfo> ccs;
      ...
      bwp1.m_bandwidth = 40e6; //cc1.m_bandwidth;
...
//      ComponentCarrierBandwidthPartElement recBwp1 = ccBwpManager.GetActiveBwpInfo(0,ccId);
  ...
  // I want to set pattern on bwp 0 of gnb 0
  // Assume numerology 3, so the number of slots per subframe is 8
  std::vector<LteNrTddSlotType> myPatternBwp0 {LteNrTddSlotType::DL, LteNrTddSlotType::DL, LteNrTddSlotType::F,
                                               LteNrTddSlotType::F, LteNrTddSlotType::UL, LteNrTddSlotType::UL,
                                               LteNrTddSlotType::UL, LteNrTddSlotType::UL};
  mmWaveHelper->GetEnbPhy (enbNetDev.Get(0), 0)->SetTddPattern (myPatternBwp0);

  // I want to set pattern on bwp 1 of gnb 0
  // Assume numerology 3, so the number of slots per subframe is 8
  std::vector<LteNrTddSlotType> myPatternBwp1 {LteNrTddSlotType::DL, LteNrTddSlotType::DL, LteNrTddSlotType::DL,
                                             LteNrTddSlotType::F, LteNrTddSlotType::UL, LteNrTddSlotType::UL,
                                             LteNrTddSlotType::UL, LteNrTddSlotType::UL};
  mmWaveHelper->GetEnbPhy (enbNetDev.Get(0), 1)->SetTddPattern (myPatternBwp1);
